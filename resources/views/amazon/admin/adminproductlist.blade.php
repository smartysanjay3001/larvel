...
<button href="" class=" btn text-decoration-none text-dark border-0 bg-success fw-bold float-end me-2 text-white py-1 "  ng-show='homeCtrl.addnew1' ng-click="homeCtrl.Show()" >Add New Product</button>

<div class="container  mt-2 p-4  w-100 rounded bg-transparent" ng-show="homeCtrl.packagelist">
